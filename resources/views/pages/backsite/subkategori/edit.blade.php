                            ...
                            <div class="col-md-6">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="subkategori" name="subkategori" value="{{ old('subkategori', $subkategori->subketagori) }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('kategori') is-invalid @enderror" id="kategori" name="kategori" style="width: 100%;">
                                            ...
                                            @foreach ($kategories as $item)
                                                <option value="{{ $item->id }}" {{ old('kategori', $subkategori->id_kategori) == $item->id ? 'selected' : '' }}>{{ $item->kategori }}</option>
                                            @endforeach
                                        </select>
                                        @error('kategori')
                                        <span class="invalid-feedback">
