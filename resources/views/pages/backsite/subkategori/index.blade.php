    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">List Subkategori</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
            ...
            <div class="container-fluid">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                @foreach ($subkategories as $sb)
                                    <tr>
                                        <td>{{ $loop->iteration }}</td>
                                        <td>{{ $sb->GetKategori->kategori}}</td>
                                        <td>{{ $sb->subketagori }}</td>
                                       
                                        <td>
                                        
                                
                                        <a href="{{ route('subkategori.edit', $sb->id ) }}" class="btn btn-success"><i
                                                class="fas fa-pen-square"></i> Edit</a>
                                        
                                            <form class="d-inline" method="post" role="alert" action="{{ route('subkategori.destroy',  $sb->id) }}">
                                                @csrf
                                                @method('delete')
                ...
                <div class="card card-primary ">
                    <div class="card-header" data-card-widget="collapse">
                      <h3 class="card-title">Log Subkategori</h3>
